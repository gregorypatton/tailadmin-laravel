...
class ProductEntity implements ProductComponent
{
    public IDTypeEnum $idType = IDTypeEnum::UNKNOWN;
    ...
    */
    ...
    public function __construct(
        ...
        ?string $fnsku,
        ?string $brand,
        ?IDTypeEnum $idType = IDTypeEnum::UNKNOWN,
        ...
        $this->kit = $this->isKit();
        $this->hideUpc = $this->isHideUpc();
        $this->activeFlag = $this->isActive();
        if(array_key_exists($this->sku, $this->customMessageSkus))
            $this->customMessage = $this->customMessageSkus[$this->sku];

    }

    public function isKit(): bool
    {
        return in_array($this->sku, $this->kitSkus);
    }

    public function isHideUpc(): bool
    {
        return in_array($this->sku, $this->hideUpcSkus);
    }

    public function isActive(): bool
    {
        return in_array($this->sku, $this->activeSkus);
    }
